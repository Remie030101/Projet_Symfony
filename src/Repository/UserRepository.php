 ...
 * 
 * Ce repository fournit des méthodes pour interagir avec la table des utilisateurs
 * et implémente PasswordUpgraderInterface pour la gestion des mots de passe
 */
